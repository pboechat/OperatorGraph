...
public:
	...
	inline static InterpreterApp* getInstance()
	{
		return s_instance;
	}
...
private:
	...
	static InterpreterApp* s_instance;
	...
	bool interpretEveryFrame;
	std::default_random_engine prng;
	std::uniform_real_distribution<float> uniform;
	std::string pgaSourceFilename;
	...
	void freeAxioms();
	void copyAxioms(std::vector<PGA::Compiler::Axiom>& compilerAxioms);
	void parse();
	void interpret();
	void dispose();
