...
namespace math
{
  ...
  class MATH_ALIGNMENT(16) vector;

  template <typename T>
  class MATH_ALIGNMENT(16) vector<T, 2U>
  {
  public:
  ...
  template <typename T>
  class MATH_ALIGNMENT(16) vector<T, 3U>
  {
  public:
  ...
  template <typename T>
  class MATH_ALIGNMENT(16) vector<T, 4U>
  {
  public:
